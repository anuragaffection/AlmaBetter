...
/*
 ...
 03. Find the second smallest element in an array

 04. Merge two sorted arrays into a single sorted array

 05. Find the longest substring without repeating characters.

 06. Find the first non-repeating character in it.
 
 07. Find the length of the longest palindromic substring.
 
 08. Determine if 2nd string is an anagram of 1st string.

 09. Check if a String Matches a Pattern
